...
/**
 * DTO de response para crear un código de invitación
 */
export class CreateInvitationCodeResponse {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'Indica si se envió el email de invitación al destinatario',
    example: true,
    type: Boolean,
    required: false,
  })
