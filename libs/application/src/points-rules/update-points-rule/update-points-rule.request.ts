...
/**
 * DTO para horario aplicable (usado en update)
 */
...
/**
 * DTO de request para actualizar una regla de puntos
 * Todos los campos son opcionales para permitir actualización parcial (PATCH)
 */
export class UpdatePointsRuleRequest {
  @ApiProperty({
  ...
  @IsNumber()
  @IsOptional()
  @ValidateIf((o) => o.pointsPerUnit !== null && o.pointsPerUnit !== undefined)
  @Min(0.01)
