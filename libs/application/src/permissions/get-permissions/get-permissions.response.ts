...
/**
 * DTO para un permiso en la lista
 */
...
/**
 * DTO de response para obtener permisos
 */
export class GetPermissionsResponse {
  ...
  @ApiProperty({
    description: 'Total de permisos encontrados',
    example: 10,
    type: Number,
  })
  total: number;

  constructor(permissions: PermissionDto[], total: number) {
