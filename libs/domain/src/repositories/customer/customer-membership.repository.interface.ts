import { CustomerMembership } from '@libs/domain/entities/customer/customer-membership.entity';
import { TopCustomer } from '@libs/domain/entities/system/tenant-analytics.entity';
...
export interface ICustomerMembershipRepository {
  ...
  /**
   * Obtiene top customers con estadísticas usando JOIN optimizado
   * Incluye userName y número de transacciones
   * @param tenantId ID del tenant
   * @param limit Número máximo de customers a retornar
   */
  getTopCustomersWithStats(
    tenantId: number,
    limit: number,
