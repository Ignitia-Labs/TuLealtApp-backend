...
export class User {
  constructor(
    ...
    public readonly avatarBackground: string | null,
  ...
  updateProfile(
    ...
    return new User(
      ...
      avatarId !== undefined ? avatarId : this.avatarId,
      avatarBackground !== undefined ? avatarBackground : this.avatarBackground,
      nextStatus,
      this.createdAt,
      new Date(),
    );
