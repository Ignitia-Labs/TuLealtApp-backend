...
import { PartnerLoyaltyProgramsController } from './controllers/partner-loyalty-programs.controller';
import { PartnerLoyaltyAnalyticsController } from './controllers/partner-loyalty-analytics.controller';
...
@Module({
  ...
  controllers: [
    ...
    PartnerLoyaltyProgramsController,
    PartnerLoyaltyAnalyticsController,
    HealthController,
  ],
  providers: [
    ...
    GetPartnerLimitsHandler,
    GetPartnerAccountBalanceHandler,
    // Handlers de aplicación - Loyalty Programs
    GetLoyaltyProgramsHandler,
    GetLoyaltyProgramHandler,
    CreateLoyaltyProgramHandler,
    UpdateLoyaltyProgramHandler,
