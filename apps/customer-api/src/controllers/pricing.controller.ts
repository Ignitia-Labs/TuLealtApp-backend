...
/**
 * Controlador de planes de precios para Customer API
 * Permite consultar planes activos y calcular precios
 *
 * Endpoints:
 * - GET /customer/pricing/plans - Obtener planes activos
 * - GET /customer/pricing/plans/:id - Obtener plan activo por ID
 * - GET /customer/pricing/plans/slug/:slug - Obtener plan activo por slug
 * - GET /customer/pricing/calculate - Calcular precio de un plan
 */
...
export class PricingController {
  ...
  @ApiOperation({
    ...
    description: 'Obtiene la lista de planes de precios activos disponibles para clientes.',
  })
  @ApiResponse({
    status: 200,
  ...
  async getPlans(): Promise<GetPricingPlansResponse> {
    ...
    request.includeInactive = false; // Solo planes activos para clientes
