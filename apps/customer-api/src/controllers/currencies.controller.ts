...
/**
 * Controlador de currencies y countries para Customer API
 * Permite obtener las monedas y países disponibles en el sistema (solo lectura)
 * Endpoints públicos - No requieren autenticación
 *
 * Endpoints:
 * - GET /customer/currencies - Obtener todas las monedas
 * - GET /customer/currencies/countries - Obtener todos los países
 */
